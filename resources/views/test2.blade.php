...
<body class="bg-white">
    ...
    <div id="layout-container" x-data="{ sidebarIsOpen: false }" class="flex flex-row bg-red-500">
			{{-- Side navbar --}}
			<nav id="side-navbar" x-bind:class="sidebarIsOpen ? 'translate-x-0' : '-translate-x-64'" class="h-svh fixed md:relative z-30 left-0 top-0 w-64 bg-fuchsia-600 transition-transform duration-300 md:translate-x-0 flex flex-col">
