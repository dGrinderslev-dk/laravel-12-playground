...
<body class="app-layout bg-white">
    ...
    <div id="layout-container" x-data="{ sidebarIsOpen: false }" class="flex flex-row bg-red-500">
			{{-- Side navbar --}}
			<nav id="side-navbar" x-bind:class="sidebarIsOpen ? 'translate-x-0' : '-translate-x-64'" class="h-dvh fixed md:static z-30 left-0 top-0 w-64 bg-fuchsia-600 transition-[transform_300ms,height_100ms_ease-out] md:translate-x-0 flex flex-col">
			...
			<div id="topnavbar-and-maincontent-wrapper" class="h-dvh transition-[height_100ms_ease-out] flex flex-col grow overflow-y-auto bg-amber-700">
					{{-- Top navbar --}}
